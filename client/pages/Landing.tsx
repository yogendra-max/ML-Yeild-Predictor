  ...
  const features = [
    {
      ...
      description:
        "Advanced machine learning algorithms analyze weather patterns and farming data to predict crop yields with high accuracy.",
    },
    {
      icon: BarChart3,
      title: "Visual Analytics",
      description:
        "Interactive charts and graphs help you understand the relationship between weather, pesticide usage, and crop performance.",
    },
    {
      icon: Target,
      title: "Precision Farming",
      description:
        "Optimize pesticide usage and farming practices based on data-driven insights for sustainable agriculture.",
    },
    {
      icon: CheckCircle,
      title: "Historical Tracking",
      description:
        "Track your farm's performance over time and identify trends to make better decisions for future seasons.",
    },
  ];
        ...
        <section className="container mx-auto px-4 py-12 md:py-20">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              Harness the power of machine learning to optimize your farming
              decisions. Get accurate yield predictions based on weather
              patterns, soil conditions, and agricultural practices.
            </p>
        ...
        <section className="container mx-auto px-4 py-16">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              ...
              need to make data-driven agricultural decisions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <Card
                  key={index}
                  className="border-2 hover:border-crop-green/20 transition-colors"
                >
                  <CardHeader>
                    <div className="flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Enter your weather conditions, soil type, and farming
                  practices
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Our AI analyzes your data against historical patterns and
                  models
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-muted-foreground">
                  Receive accurate yield predictions with confidence scores and
                  insights
                </p>
              </div>
            </div>
          ...
          <Card className="bg-gradient-to-r from-crop-green to-crop-green/80 text-white border-0">
            <CardContent className="p-8 md:p-12 text-center">
              ...
              <p className="text-lg md:text-xl mb-8 text-white/90 max-w-2xl mx-auto">
                ...
                their crop yields and reduce costs.
              </p>
              <Button
                size="lg"
                variant="secondary"
